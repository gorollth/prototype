...
export const sampleRoutes: Route[] = [
  ...
  {
    id: 23,
    title: "Asok Intersection to Exchange Tower",
    distance: "0.3 km",
    duration: "13 min",
    rating: 4.9,
    date: "2024-01-17",
    type: "saved",
    from: "Asok Intersection",
    to: "Exchange Tower",
    description:
      "Wheelchair-friendly route with accessible sidewalks, ramps, and signage.",
    accessibility: "High",
    features: [
      "Smooth pavement",
      "Ramps available",
    ...
    path: [
      [13.737278, 100.562182],
      [13.730313, 100.571124],
    ],
  },
  {
    id: 24,
    title: "Sukhumvit Soi 23 to BTS Asok",
    distance: "0.3 km",
    duration: "4 min",
    rating: 4.7,
    date: "2024-02-20",
    type: "recent",
    from: "Sukhumvit Soi 23",
    to: "BTS Asok",
    description:
      "Wheelchair-friendly route with accessible sidewalks, ramps, and signage.",
    accessibility: "High",
    ...
    path: [
      [13.7361, 100.558985],
      [13.732074, 100.571149],
    ],
  },
  {
    id: 25,
    title: "Benjakitti Park to MRT Queen Sirikit",
    distance: "1.1 km",
    duration: "10 min",
    rating: 4.9,
    date: "2024-01-27",
    ...
    path: [
      [13.736812, 100.558569],
      [13.730531, 100.568323],
    ],
  },
  {
    id: 26,
    title: "BTS Phrom Phong to EmQuartier",
    distance: "0.9 km",
    duration: "12 min",
    rating: 4.5,
    date: "2024-03-24",
    ...
    path: [
      [13.736573, 100.560549],
      [13.731086, 100.570095],
    ],
  },
  {
    id: 27,
    title: "BTS Ekkamai to Major Cineplex",
    distance: "1.1 km",
    duration: "19 min",
    rating: 4.3,
    date: "2024-01-19",
    ...
    path: [
      [13.735525, 100.559537],
      [13.729416, 100.57115],
    ],
  },
  {
    id: 28,
    title: "BTS Thonglor to Market Place",
    distance: "1.1 km",
    duration: "17 min",
    rating: 4.9,
    date: "2024-03-19",
    ...
    path: [
      [13.738367, 100.560253],
      [13.731047, 100.571689],
    ],
  },
  {
    id: 29,
    title: "Sukhumvit Soi 22 to Benchasiri Park",
    distance: "0.4 km",
    duration: "9 min",
    rating: 4.9,
    date: "2024-02-17",
    type: "recent",
    from: "Sukhumvit Soi 22",
    to: "Benchasiri Park",
    description:
      "Wheelchair-friendly route with accessible sidewalks, ramps, and signage.",
    accessibility: "High",
    ...
    path: [
      [13.738001, 100.559218],
      [13.732415, 100.569274],
    ],
  },
  {
    id: 30,
    title: "Asok Montri Road to Terminal 21",
    distance: "0.5 km",
    duration: "12 min",
    rating: 5.0,
    date: "2024-02-25",
  ...
  },
  {
    ...
    path: [
      [13.735514, 100.558931],
      [13.72891, 100.5697],
    ],
  },
  {
    id: 32,
    title: "BTS Phrom Phong to Benchasiri Park",
    distance: "0.6 km",
    duration: "14 min",
    rating: 4.6,
    date: "2024-03-25",
    ...
    path: [
      [13.738539, 100.561572],
      [13.732026, 100.571241],
    ],
  },
];
